          ...
          <div className="row align-items-center">
            <div className="col-lg-7">
              <div className="fade-in-up">
                <span
                  className="badge bg-primary bg-opacity-25 text-primary px-3 py-2 mb-3 rounded-pill"
                ...
                <p className="hero-subtitle">
                  Report municipal issues like potholes, water leakage, garbage
                  collection, and more. Track your complaints in real-time and
            ...
            <div className="col-lg-5 d-none d-lg-block text-center">
              <div
                ...
                style={{ fontSize: "12rem", opacity: 0.15, color: "#fff" }}
              >
        ...
        <div className="container">
          <div className="text-center mb-5">
            ...
            <p className="section-subtitle">
              Report any municipal issue and we'll make sure it reaches the
              right department
            </p>
          </div>
          ...
          <div className="row g-4">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="service-card fade-in-up">
                ...
                <h5>Water Supply</h5>
                <p>
                  Report water leakage, contamination, low pressure, or supply
                  disruption issues.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="service-card fade-in-up fade-in-up-delay-1">
                ...
                <h5>Road & Pothole</h5>
                <p>
                  Report potholes, road damage, broken footpaths, and
                  construction debris.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="service-card fade-in-up fade-in-up-delay-2">
                ...
                <p>
                  Report broken or non-functional streetlights, electrical
            ...
            <div className="col-lg-4 col-md-6">
              <div className="service-card fade-in-up">
                ...
                <p>
                  Report blocked drains, sewage overflow, and waterlogging in
                  your area.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="service-card fade-in-up fade-in-up-delay-1">
                ...
                <p>
                  Report missed garbage pickups, overflowing bins, and illegal
                  dumping.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="service-card fade-in-up fade-in-up-delay-2">
                ...
                <p>
                  Report any other municipal issue that needs attention in your
                  locality.
                </p>
              </div>
            </div>
            ...
            <div className="col-md-4">
              <div className="text-center p-4">
                ...
                <p className="text-muted">
                  Create your free account as a citizen in just a few seconds.
                </p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="text-center p-4">
                ...
                <p className="text-muted">
                  Describe the issue, select department, and upload a photo.
                </p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="text-center p-4">
                ...
                <p className="text-muted">
                  Track your complaint status as the officer resolves it.
                </p>
              </div>
            </div>
          </div>
