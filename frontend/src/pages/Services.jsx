    ...
    <>
      ...
      <section className="page-hero">
        <div className="container">
          <h1>Our Services</h1>
          <p>
            Comprehensive municipal services to keep your city running smoothly
          </p>
        </div>
      </section>
              ...
              <div className="col-lg-4 col-md-6" key={dept.departmentId}>
                <div className="service-card">
                  <div className="icon-box">
                    <i
                      className={`bi ${deptIcons[dept.departmentName] || "bi-building"}`}
                    ></i>
                  </div>
                  <h5>{dept.departmentName}</h5>
                  <p>
                    {dept.description ||
                      "Handles complaints related to this department."}
                  </p>
                </div>
              </div>
            ))}
