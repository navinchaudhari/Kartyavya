...
Status: Pre-Day-1 scaffold generated from the frozen v1.0 Technical Contracts and the Exclusive Ownership
Seven-Day Plan. No business logic has been implemented yet - this is the frozen skeleton every member scaffolds
from on Day 1.

## Start here
1. Read `docs/contracts/architecture.md` first, then every other file in `docs/contracts/`.
2. Read `.agents/rules/kartyavya-project.md` - this is the rule file Antigravity (or any AI coding agent) must
   load before touching any code.
3. Find your row in `docs/contracts/member-ownership.md` - you may only edit your own folder(s).
